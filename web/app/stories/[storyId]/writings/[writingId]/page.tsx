        ...
        <Card className="p-8 bg-surface border-border">
          {isEditing ? (
            <textarea
              ...
              className="w-full min-h-[600px] bg-background border border-border rounded-lg p-6 text-foreground font-serif text-lg leading-relaxed resize-none focus:outline-none focus:ring-2 focus:ring-primary/50"
